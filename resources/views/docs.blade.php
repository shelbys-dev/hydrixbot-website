...
@section('title', 'Hydrix Bot — Documentation')
@section('meta_description', 'Hydrix Bot - Documentation, guide d\'installation et commandes')
            ...
            <main class="card">
                ...
                <section class="section" id="contact">
                    ...
                    <p>Support : <a href="mailto:contact@shelbydev.fr">contact@shelbydev.fr</a>. Voir aussi les <a
                            href="{{ route('tos') }}">Conditions d’utilisation</a> et la <a href="{{ route('privacy') }}">Politique de
                            confidentialité</a>.</p>
                    <hr />
                    <div class="footer">
